      ...
      <div class="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
        ...
        <div class="bg-white lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap md:flex-wrap items-center">
          ...
          <div class="w-full lg:w-1/5 mt-6 lg:mt-0 lg:px-4 text-center md:text-left">
            ...
            <h2 className='text-pink-500 bg-pink-100 rounded text-xl text-center font-bold border-solid border-grey w-1/3 lg:w-full py-2'>
    ...
    <div class="bg-white w-full md:w-2/3">
      ...
      <div class="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
        ...
        <div class="bg-white lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap md:flex-wrap items-center">
          ...
          <div class="w-full lg:w-3/5 lg:px-3">
            <p class="text-md mt-4 lg:mt-0 text-justify md:text-left text-md">
            The Movie Database Project is your go-to hub for all things cinema. Explore a vast collection of movies, complete with cast details, ratings, trailers, and more. Dive into various genres and discover related films to expand your cinematic horizons. Whether you're a film enthusiast or seeking your next movie night pick, we've got you covered. Explore the magic of the silver screen with us! </p>
          </div>
